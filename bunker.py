...
bunker_img1 = pic("assets/broken_bunker.png")
bunker_img2 = pic("assets/damaged_bunker.png")
bunker_img3 = pic("assets/full_health_bunker.png")


class Bunker:
    x = 0  # initialize coordinates of bunker
    y = 0
    width = 70  # initialize size of bunker
    height = 70
